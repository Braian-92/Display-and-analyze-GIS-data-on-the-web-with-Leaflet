...
<script type="text/javascript">
  ...
  let polylineInt = L.polyline(
  [[-36.500775938786475, -62.56713884150876], [-37.683628706871076, -61.84204122916396], [-37.99592866727713, -59.66674839212957], [-36.659554919182185, -58.45825237155492], [-35.433939034226114, -58.216553167439976], [-34.19846656457314, -59.249267948658336], [-34.3799802793998, -60.76538113810653], [-35.05715245543503, -62.39135760215244], [-35.245820567836454, -62.006836443075095], [-34.669641596533594, -60.16113342983379], [-34.832101145237345, -59.23828192321313], [-35.1740199280072, -59.63378971176484], [-35.85355564121265, -60.97412166185675], [-35.335482030800016, -62.42431688654633], [-35.20992818485964, -62.99560591445436], [-37.387520703645244, -62.86376998493712], [-38.186180899642125, -62.46826219638542], [-38.44474374679728, -60.02929750031655], [-37.70106759945626, -58.710938205144195], [-36.13795096785529, -57.89794997312126], [-36.27976367498337, -57.370606255052316], [-37.33513476034979, -57.61230545916724], [-38.03060097132567, -58.62304758546603], [-38.496345618230194, -59.50195378224761], [-38.58226665052844, -60.908203697098116], [-38.47914909761984, -62.31445361194863], [-38.41032198698982, -62.95166060461527], [-39.35092766706278, -62.9077152947762], [-40.16161321505065, -63.083496534132514], [-40.529983242703324, -63.083496534132514], [-40.696758677265095, -62.66601609066126], [-40.25412789437379, -62.73193381992832], [-39.50389383322475, -62.7099611650088], [-38.72833552677415, -62.611084217870875], [-38.68547528780813, -62.02880886250306], [-38.68547528780813, -60.35888708861808]]
  , {color:'yellow'}).addTo(map);

  let grupo = L.featureGroup([poligono,polylineInt]).addTo(map);
  ...
  let ctlEasyButtonCapas = L.easyButton('fa fa-coffee', function(){
    //! agregar marcador a capa
    if(grupo.hasLayer(marcadorCentro)){
      grupo.removeLayer(marcadorCentro);
      toastr.error("Se quito el marcador centro de las capas");
    }else{
      grupo.addLayer(marcadorCentro);
      toastr.success("Se agrego el marcador centro de las capas");
    }
  }).addTo(map);

  let ctlEasyButtonColorCapas = L.easyButton('fa fa-tags', function(){
    grupo.setStyle({
      color:'purple',
      fillColor:'orange',
      fillOpacity:.6,
    });
    toastr.success("Se cambio el color de las capas");
    
  }).addTo(map);

  let objOverlays = {
    'BsAs-Jujuy' : poligono,
    'Circuito' : polylineInt,
    'grupo': grupo
  };
